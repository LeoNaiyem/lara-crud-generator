    ...
    <div class="card mb-3 p-4">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                <thead class="thead-dark"><tr><th>Id</th><th>Name</th><th>Department id</th><th>Designation</th><th>Actions</th></tr></thead>
                <tbody>
                @foreach ($consultants as $item)
                    <tr><td>{{ $item->id }}</td><td>{{ $item->name }}</td><td>{{ optional($item->department)->name ?? $item->department_id }}</td><td>{{ $item->designation }}</td><td>
